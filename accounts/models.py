...
from ecommerce.utils import random_string_generator, unique_key_generator, unique_order_id_generator
...
class User(AbstractBaseUser):
    ...
    REQUIRES_FIELDS = [] #['full_name'] #python manage.py createsuperuser
...
class EmailActivation(models.Model):
    ...
    def activate(self):
        if self.can_activate():
            ...
            user.is_active= True
            user.save()
            # signal for user just activated
            self.activated= True
            self.save()
            return True
        return False
